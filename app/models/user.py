...
class User(Base):
    ...
    blacklist_entries_added = relationship("Blacklist", back_populates="added_by_user", passive_deletes=True)
    whitelist_entries_added = relationship("Whitelist", back_populates="added_by_user", passive_deletes=True)
